...
const products = [
    { id: 1, name: "Bags Brand", image: "images/lv.jpg.webp" },
    { id: 2, name: "Cosmetics Brand", image: "images/dior.jpg" },
    { id: 3, name: "Glasses Brand", image: "images/miu.jpg" },
    { id: 4, name: "Sneakers Brand", image: "images/nike.jpeg" },
    { id: 5, name: "Perfumes Brand", image: "images/prada.avif" },
    { id: 6, name: "Clothes Brand", image: "images/gucci.PNG" },
    { id: 7, name: "Tech Brand", image: "images/apple.jpg" },
    { id: 8, name: "Jewelry Brand", image: "images/pand.jpg" }
];
...
// Restore brown highlights for items that were previously added
...
function addToCart(productId, buttonElement) {
    ...
    // Add brown highlight only once (first time item is added)
...
function removeFromCart(productId) {
    ...
    // Remove brown highlight when item is removed
    const productCard = document.querySelector(`[data-id="${productId}"]`);
    if (productCard) {
        const imageWrapper = productCard.querySelector('.product-image-wrapper');
